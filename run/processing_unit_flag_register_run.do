...
vlog -reportprogress 300 +incdir+../design -work work ../test/tb_processing_unit_flag_register.v
vsim work.tb_processing_unit_flag_register
do ../themes/waves_processing_unit_flag_register.do
run 2.0 us
wave zoom full
